...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Register || Mojang Shop</title>
  ...
  <body>
      ...
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Infinite Loop" name="address" required>
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="nayantronix@gmail.com" name="email" required>
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer>
           <p style="text-align:center; font-size:0.8em;">&copy; Mojang Shop. All Rights Reserved.</p>
        </footer>
